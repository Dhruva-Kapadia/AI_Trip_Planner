...
class GooglePlaceSearchTool:
    ...
    def google_search_attraction(self, place: str) -> dict:
        return self.places_tool.run(f"top attractive placess in and around {place}")
    ...
    def google_search_activity(self, place: str) -> dict:
        return self.places_tool.run(f"Activites in and around {place}")
    
    def google_search_transportation(self, place: str) -> dict:
        return self.places_tool.run(f"What are the different modess of transportations available in {place}")
